 ...
 */
package com.soulware.youme.ui.controls.viewflow;
...
/**
 */
public class TimelineIndicator extends TextView implements FlowIndicator {
	 ...
	 * @param attrs
	 */
	public TimelineIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);
