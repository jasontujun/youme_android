...
//------------------------------------- Begin of Flood Fill
	...
	if (IsIndexed()){ //--- Generic indexed image, no tolerance OR Grayscale image with tolerance
		...
		BYTE idxMin = (BYTE)x_min(255, x_max(0,(int)(idxRef - nTolerance)));
		BYTE idxMax = (BYTE)x_min(255, x_max(0,(int)(idxRef + nTolerance)));
		...
		cRefMin.rgbRed   = (BYTE)x_min(255, x_max(0,(int)(cRef.rgbRed   - nTolerance)));
		cRefMin.rgbGreen = (BYTE)x_min(255, x_max(0,(int)(cRef.rgbGreen - nTolerance)));
		cRefMin.rgbBlue  = (BYTE)x_min(255, x_max(0,(int)(cRef.rgbBlue  - nTolerance)));
		cRefMax.rgbRed   = (BYTE)x_min(255, x_max(0,(int)(cRef.rgbRed   + nTolerance)));
		cRefMax.rgbGreen = (BYTE)x_min(255, x_max(0,(int)(cRef.rgbGreen + nTolerance)));
		cRefMax.rgbBlue  = (BYTE)x_min(255, x_max(0,(int)(cRef.rgbBlue  + nTolerance)));
